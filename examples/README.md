...
The following are examples from <https://github.com/matusnovak/finegraphics/examples>.
...
[Load an image into GLTexture2D and render it using the Canvas](https://github.com/matusnovak/finegraphics/examples/image.cpp)
